document.getElementById('dtj').style.visibility = 'hidden'
...
var Snake = (function() {
  ...
  var game = {
    ...
    loop: function() {
      ...
      if (!stopped) {
        ctx.fillStyle = 'rgba(700,200,200,0.2)';
        ctx.font = "small-caps 14px Helvetica";
        ctx.fillText("x", 24, 356);
        ctx.fillText("x", 24, 374);
      }
      ...
      if (player.x == fruit.x && player.y == fruit.y) {
        ...
        if (points === 3) {
          points = 999;
          ctx.fillStyle = 'rgba(700,200,200,0.2)';
          ctx.font = "small-caps 100px Helvetica";
          ctx.fillText("Die", 24, 374);
        }
        if (points === 1000) {
          points = 5;
          ctx.fillStyle = 'rgba(700,200,200,0.2)';
          ctx.font = "small-caps 50px Helvetica";
          ctx.fillStyle = 'red'
          ctx.fillText("You Cant...", 24, 374);
        }
        ...
        if (points === 20) {
          tileCount = 30;
          gridSize = 300 / tileCount;
          pointsMax = 'back on start';
        }
        if (points === 35) {

          pointsMax = 'hello';
          fps = 1;
          document.getElementById('dtj').style.visibility = 'visible';
      ...
      if (!stopped) {
        ...
        ctx.font = "small-caps bold 24px Helvetica";
        ctx.fillText("", 0, 174);
      }
...
sdd = document.getElementById('gc')
